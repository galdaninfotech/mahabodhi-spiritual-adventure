          ...
          <div class="mkdf-title-holder mkdf-standard-type mkdf-title-va-header-bottom mkdf-preload-background mkdf-has-bg-image mkdf-bg-responsive-disabled" style="height: 452px;background-image:url(/images/blog-post-img-35.jpg);" data-height="452">
              ...
              <div class="mkdf-title-wrapper" style="height: 302px;padding-top: 150px">
                  <div class="mkdf-title-inner">
                      <div class="mkdf-grid">
                            <h2 class="mkdf-page-title entry-title">Yoga and Meditation At Exotic Locations</h2>
                            <p class="breadcrumbs">
                                <span class="me-2"><a href="/">Home &gt;</a></span> 
                                <span class="me-2"><a href="#">Unique Offerings &gt;</a></span>
                                <span style="color: #59815b">Yoga and Meditation At Exotic Locations</span>
                            </p>
                      </div>
                  </div>
              </div>
                                      ...
                                      <div class="mkdf-post-content">
                                          <div class="mkdf-post-heading">
                                              <div class="mkdf-post-image">
                                                  <a itemProp="url" href="/unique-offerings/yoga-and-meditation-at-exotic-locations/" title="yoga-and-meditation-at-exotic-locations/">
                                                  <ImgBlogPostImg33 />	</a>
                                              </div>
                                              ...
                                              <div class="mkdf-post-text-inner">
                                                <div class="mkdf-post-info-top">
                                                    ...
                                                    <div class="mkdf-post-info-author">
                                                        ...
                                                        <a itemProp="author" class="mkdf-post-info-author-link" href="/unique-offerings/yoga-and-meditation-at-exotic-locations/">
                                                        Ladakh Meditation Retreat & Exploration</a>
                                                    </div>
                                                </div>
                                                <div class="mkdf-post-text-main">
                                                    <h3 itemProp="name" class="entry-title mkdf-post-title">
                                                        <a itemProp="url" href="#" title="Yoga and Meditation At Exotic Locations"> Yoga and Meditation At Exotic Locations </a>
                                                    </h3>

                                                    <div class="mkdf-post-excerpt-holder">
                                                        <p itemProp="description" class="mkdf-post-excerpt">
                                                            Experience yoga and meditation sessions at some of Ladakh's most breathtaking locations. Practice by the pristine shores of Pangong Lake, amidst the towering peaks of Nubra Valley, or in the tranquil gardens of ancient monasteries. Each session is designed to connect you deeply with the natural beauty around you.
                                                        </p>
                                                    </div>
...
export const head: DocumentHead = {
  title: 'Yoga and Meditation At Exotic Locations',
  meta: [
    {
      name: 'description',
      content: 'Yoga and Meditation At Exotic Locations',
    },
  ],
};