          ...
          <div class="mkdf-title-holder mkdf-standard-type mkdf-title-va-header-bottom mkdf-preload-background mkdf-has-bg-image mkdf-bg-responsive-disabled" style="height: 452px;background-image:url(/images/blog-post-img-35.jpg);" data-height="452">
              ...
              <div class="mkdf-title-wrapper" style="height: 302px;padding-top: 150px">
                  <div class="mkdf-title-inner">
                      <div class="mkdf-grid">
                            <h2 class="mkdf-page-title entry-title">Eco-Friendly Accommodations</h2>
                            <p class="breadcrumbs">
                                <span class="me-2"><a href="/">Home &gt;</a></span> 
                                <span class="me-2"><a href="#">Unique Offerings &gt;</a></span>
                                <span style="color: #59815b">Eco-Friendly Accommodations</span>
                            </p>
                      </div>
                  </div>
              </div>
                                      ...
                                      <div class="mkdf-post-content">
                                          <div class="mkdf-post-heading">
                                              <div class="mkdf-post-image">
                                                  <a itemProp="url" href="/unique-offerings/eco-friendly-accommodations/" title="eco-friendly-accommodations/">
                                                  <ImgBlogPostImg33 />					</a>
                                              </div>
                                              ...
                                              <div class="mkdf-post-text-inner">
                                                <div class="mkdf-post-info-top">
                                                    ...
                                                    <div class="mkdf-post-info-author">
                                                        ...
                                                        <a itemProp="author" class="mkdf-post-info-author-link" href="/unique-offerings/eco-friendly-accommodations/">
                                                        Ladakh Meditation Retreat & Exploration</a>
                                                    </div>
                                                </div>
                                                <div class="mkdf-post-text-main">
                                                    <h3 itemProp="name" class="entry-title mkdf-post-title">
                                                        <a itemProp="url" href="#" title="Eco-Friendly Accommodations"> Eco-Friendly Accommodations </a>
                                                    </h3>

                                                    <div class="mkdf-post-excerpt-holder">
                                                        <p itemProp="description" class="mkdf-post-excerpt">
                                                            Stay in eco-conscious lodges and guesthouses that reflect the spirit of Ladakh while minimizing environmental impact. Enjoy comfort and sustainability in the heart of nature.
                                                        </p>
                                                    </div>
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: 'description',
      content: 'Eco-Friendly Accommodations',
    },
  ],
};