                                              ...
                                              <div class="mkdf-post-text-inner">
                                                <div class="mkdf-post-info-top">
                                                    ...
                                                    <div class="mkdf-post-info-author">
                                                        ...
                                                        <a itemProp="author" class="mkdf-post-info-author-link" href="/upcoming-retreats/meditation-in-the-monasteries/">
                                                        Ladakh Meditation Retreat & Exploration</a>
                                                    </div>
                                                </div>
                                                <div class="mkdf-post-text-main">
                                                    <h3 itemProp="name" class="entry-title mkdf-post-title">
                                                        <a itemProp="url" href="#" title="meditation-in-the-monasteries/"> Meditation In The Monasteries </a>
                                                    </h3>

                                                    <div class="mkdf-post-excerpt-holder">
                                                        <p itemProp="description" class="mkdf-post-excerpt">
                                                            Delve deep into meditation with our monastery retreat. Experience tranquil surroundings, participate in traditional Buddhist rituals, and enjoy mindfulness sessions led by experienced instructors. This retreat is designed to deepen your practice in the serene embrace of Ladakh’s spiritual heritage.
                                                        </p>
                                                    </div>
...
export const head: DocumentHead = {
  title: 'Meditation In The Monasteries',
  meta: [
    {
      name: 'description',
      content: 'Meditation In The Monasteries',
    },
  ],
};